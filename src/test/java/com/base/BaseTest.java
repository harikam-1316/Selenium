...
import com.source.createPO.POsendforapproval.POsendforApprovalTest;
...
import com.source.requisition.create.CreatenoncatalogTest;
...
import com.source.login.LoginTest;
import com.source.requisition.create.CreateTest;

import com.source.requisition.sendforapproval.SendforApproval;
import com.source.requisition.sendforapproval.SendforApprovalTest;
...
public class BaseTest {
    ...
    protected POsendforApprovalTest pOsendforApprovalTest;
    ...
    protected CreatenoncatalogTest createnoncatalogTest;
...
//TODO Login Object
            ...
            pOsendforApprovalTest =new POsendforApprovalTest();
            ...
            createnoncatalogTest = new CreatenoncatalogTest();
            ...
            System.out.println("Error in initializing SetUp Function");
        }
    }
