...
public class PoRsendforApprovalnoncatalog {
    private Login login;
    private Logout logout;
    private WebDriverWait webDriverWait;

    public PoRsendforApprovalnoncatalog(Login login, Logout logout, WebDriverWait webDriverWait) {
        this.login = login;
        this.logout = logout;
    ...
    public void SelectSendApproval() throws InterruptedException {
        ...
        WebElement porTab = webDriverWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"ni-purchase-order-requests\"]/a/span")));
        porTab.click();
