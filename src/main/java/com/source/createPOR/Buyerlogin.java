...
public class Buyerlogin {
    ...
    public Buyerlogin(WebDriver driver, WebDriverWait webDriverWait, Login login, Logout logout, Properties properties) {
        this.login = login;
        this.driver = driver;
    ...
    public void selectBuyerAndAssign() throws InterruptedException {
        ...
        WebElement createPorButton = webDriverWait.until(ExpectedConditions.elementToBeClickable(By.id("btnCreatePOR")));
        createPorButton.click();
        System.out.println("Clicked on Create POR button");
        ...
        WebElement yesButton = webDriverWait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[6]/div/div/div[2]/button[1]")));
        yesButton.click();
