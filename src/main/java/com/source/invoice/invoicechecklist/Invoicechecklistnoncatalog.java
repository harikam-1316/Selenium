...
public class Invoicechecklistnoncatalog {
    ...
    public Invoicechecklistnoncatalog(WebDriver driver, WebDriverWait wait, Login login, Logout logout, Properties properties) {
        this.driver = driver;
