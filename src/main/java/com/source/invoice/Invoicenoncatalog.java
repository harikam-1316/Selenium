...
import static com.constants.requisitions.create.PRCreate.INVOICENUMBER_ID;
import static com.constants.requisitions.create.PRCreate.PURCHASE_ORDER_DROPDOWN_XPATH;
import static com.constants.requisitions.create.PRCreate.PURCHASE_ORDER_SEARCH_XPATH;
import static com.constants.requisitions.create.PRCreate.getpurchaseOrder;

public class Invoicenoncatalog {
    ...
    public Invoicenoncatalog(WebDriver driver, WebDriverWait wait, Login login, Logout logout, Properties properties) {
        this.driver = driver;
