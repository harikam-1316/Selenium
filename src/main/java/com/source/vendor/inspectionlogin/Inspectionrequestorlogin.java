...
public class Inspectionrequestorlogin {
    private Login login;
    ...
    public Inspectionrequestorlogin(Login login, Logout logout, WebDriverWait webDriverWait, WebDriver webDriver, Properties properties) {
        this.login = login;
        this.logout = logout;
        this.webDriverWait = webDriverWait;
        this.driver = webDriver;          // ✅ assign correct driver
