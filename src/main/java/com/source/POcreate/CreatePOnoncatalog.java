...
public class CreatePOnoncatalog {
    private Login login;
    ...
    public CreatePOnoncatalog(Login login, Logout logout, WebDriverWait wait, WebDriver webDriver, FileOutputStream fileOutputStream, Properties properties) {
